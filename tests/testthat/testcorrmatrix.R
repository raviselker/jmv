...
testthat::test_that('All options in the corrMatrix work (sunny)', {
    ...
    testthat::expect_equal(
        -0.0247,
        as.numeric(corTable$getCell(rowKey = "var 3", "var 1[r]")$value),
        tolerance = 1e-4
    )
    testthat::expect_equal(
        -0.647,
        as.numeric(corTable$getCell(rowKey = "var 3", "var 2[r]")$value),
        tolerance = 1e-3
    )
    ...
    testthat::expect_equal(
        0.936,
        as.numeric(corTable$getCell(rowKey = "var 3", "var 1[rp]")$value),
        tolerance = 1e-3
    )
    testthat::expect_equal(
        0.0315,
        as.numeric(corTable$getCell(rowKey = "var 3", "var 2[rp]")$value),
        tolerance = 1e-4
    )
    ...
    testthat::expect_equal(
        0.651,
        as.numeric(corTable$getCell(rowKey = "var 2", "var 1[rciu]")$value),
        tolerance = 1e-3
    )
    testthat::expect_equal(
        0.534,
        as.numeric(corTable$getCell(rowKey = "var 3", "var 1[rciu]")$value),
        tolerance = 1e-3
    )
    testthat::expect_equal(
        -0.0766,
        as.numeric(corTable$getCell(rowKey = "var 3", "var 2[rciu]")$value),
        tolerance = 1e-4
    )
    ...
    testthat::expect_equal(
        -0.544,
        as.numeric(corTable$getCell(rowKey = "var 2", "var 1[rcil]")$value),
        tolerance = 1e-3
    )
    testthat::expect_equal(
        -0.568,
        as.numeric(corTable$getCell(rowKey = "var 3", "var 1[rcil]")$value),
        tolerance = 1e-3
    )
    testthat::expect_equal(
        -0.898,
        as.numeric(corTable$getCell(rowKey = "var 3", "var 2[rcil]")$value),
        tolerance = 1e-3
    )
    ...
    testthat::expect_equal(
        -0.225,
        as.numeric(corTable$getCell(rowKey = "var 3", "var 1[rho]")$value),
        tolerance = 1e-3
    )
    testthat::expect_equal(
        -0.569,
        as.numeric(corTable$getCell(rowKey = "var 3", "var 2[rho]")$value),
        tolerance = 1e-3
    )
    ...
    testthat::expect_equal(
        0.459,
        as.numeric(corTable$getCell(rowKey = "var 3", "var 1[rhop]")$value),
        tolerance = 1e-3
    )
    testthat::expect_equal(
        0.0674,
        as.numeric(corTable$getCell(rowKey = "var 3", "var 2[rhop]")$value),
        tolerance = 1e-4
    )
    ...
    testthat::expect_equal(
        -0.119,
        as.numeric(corTable$getCell(rowKey = "var 3", "var 1[tau]")$value),
        tolerance = 1e-3
    )
    testthat::expect_equal(
        -0.408,
        as.numeric(corTable$getCell(rowKey = "var 3", "var 2[tau]")$value),
        tolerance = 1e-3
    )
    ...
    testthat::expect_equal(
        0.579,
        as.numeric(corTable$getCell(rowKey = "var 3", "var 1[taup]")$value),
        tolerance = 1e-3
    )
    testthat::expect_equal(
        0.0942,
        as.numeric(corTable$getCell(rowKey = "var 3", "var 2[taup]")$value),
        tolerance = 1e-4
    )
