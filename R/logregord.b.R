#' @importFrom jmvcore .
logRegOrdClass <- if (requireNamespace('jmvcore'))
    R6::R6Class(
        "logRegOrdClass",
        ...
        private = list(
            ...
            .initCoefTables = function() {
                ...
                ciWidthORTitle <- jmvcore::format(
                    ciWidthTitleString,
                    ciWidth = self$options$ciWidthOR
                )
            ...
            .initThresTables = function() {
                ...
                for (i in seq_along(termsAll)) {
                    ...
                    for (k in 1:(length(depLevels) - 1)) {
                        rowKey <- paste0(
                            jmvcore::toB64(depLevels[k]),
                            '|',
                            jmvcore::toB64(depLevels[k + 1])
                        )
